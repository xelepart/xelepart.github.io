...
function checkAndHardReset() {
   if (confirm("You really want to start completely over?")) {
...
function resetGame() {
    ...
    registerTaskDefinition({
        storyline:"farmer",
        taskid:"farm1",
        imageUrl:'images/carrots1_icon.png',
        repeatable:true,
        completionCosts:null,
        passiveGeneration:null,
        completionGeneration:{Carrots:1},
        ...
        completionstory:"Success! You took dirt and turned it into delicious carrots! One whole unit of carrots! What do carrots come in, anyway? Bushels? Pounds? Cartloads? These are the conversations I have with my friends now. I'm going with units. One unit of carrots. You're welcome.",
    ...
    registerTaskDefinition({
        ...
        name:"Clear Rocks",
        predescription:"Now that you've got some experience farming, you realize rocks kinda get in the way. Like. Really in the way. If carrots felt hate, you are sure they would hate rocks. You're thinking maybe you should remove them. It'll be a lot of work, but you're pretty sure it'll pay off.",
    ...
    registerTaskDefinition({
        ...
        completionGeneration:{Carrots:2},
        completionLearn:null,
        completionTools:null,
    ...
    registerTaskDefinition({
        ...
        repeatable:true,
        passiveGeneration:null,
        completionCosts:{Carrots:25},
        completionGeneration:{gold:10},
        completionLearn:null,
        completionTools:null,
        completionYears:0.5,
        categories:null,
        unlock:{resourceName:"Carrots", amount:10, permanent:true},
        parenttask:{taskid:"farm1"},
        parentoffset:{x:0,y:60},
        hint:"If only you had a surplus of carrots...",
        name:"Sell Carrots",
        predescription:"Okay, you're starting to build up carrots. More than you can eat, certainly... There's probably a merchant in the city willing to take a cartload off your hands.",
        completionstory:"It was a long, dusty road to the city, but you found a merchant willing to take your carrots! What luck!",
        description:"Sell those carrots!",
    });
    ...
    registerTaskDefinition({
        ...
        name:"Buy Tools",
        predescription:"While the general education was great, the most valuable thing your teacher taught you was the password to the underground farming tools market. 'carrots' .......... yeah, I thought so too.",
        completionstory:"You utter that sweet, sweet phrase.... 'carrots'.... and the door swings open to a bustling panoply of carts and vendors showing off the latest and greatest in farming technology. There's a scythe store, a gloves store, some well-bred carrot seed stores... everything a farmer in whatever universe and/or century this is could ask for. You buy some fine tools and head back home.",
    ...
    registerTaskDefinition({
        ...
        name:"Apprentice",
        predescription:"You recall a neighboring peasant mentioning to you, as your workers tilled the fields in a previous life, that they'd wished they'd known you might take on help when their children were younger, one of them had always wanted to be an apprentice farmer... They even said they'd have paid you to take on an apprentice! Well, now you know, and they are a child once again, sooooo....",
        completionstory:"You bring on the child, it takes time to train them, but they are an absolute joy. Hard working, productive, eager, and absolutely brilliant. You grow to love them as your own. And, with their help, you may finally have time to pursue other interests in life...",
    ...
    if (false) {
        registerTaskDefinition({
            ...
            completionTools:{farming:10},
            completionYears:1,
            unlock:{completedtasksand:["sellcarrots","farm2"]},
            parenttasksor:["sellcarrots","farm2"],
